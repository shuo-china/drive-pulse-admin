  ...
  <el-dialog v-model="visible" :width="300">
    <div class="flex flex-col items-center justify-center pt-6 pb-8">
      ...
      <div class="h-40 w-40 rounded-xs border border-black/20">
        <iframe sandbox="allow-scripts allow-top-navigation allow-same-origin" scrolling="no" frameBorder="0"
          width="100%" height="100%" allowTransparency="true" :src="src"></iframe>
      </div>
    </div>
  </el-dialog>
</template>
